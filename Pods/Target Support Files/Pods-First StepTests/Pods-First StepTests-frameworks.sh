...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ReactiveSwift-iOS10.2/ReactiveSwift.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RestKit-iOS10.2/RestKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Result-iOS10.2/Result.framework"
